...
class PortfolioRegister implements PostTypeInterface {
	...
	private function registerPostType() {
		...
		if(mkd_core_theme_installed()) {
			$menuPosition = sienna_mikado_framework()->getSkin()->getMenuItemPosition('portfolio');
			$menuIcon     = sienna_mikado_framework()->getSkin()->getMenuIcon('portfolio');

			if(isset($sienna_mikado_options['portfolio_single_slug'])) {
				if($sienna_mikado_options['portfolio_single_slug'] != "") {
					$slug = $sienna_mikado_options['portfolio_single_slug'];
				}
			}
		}
