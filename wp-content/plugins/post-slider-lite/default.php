...
add_filter('sangar_slider_default_options_slide', function($data){
	...
	$options['tab-bg-html'] = '';
	$options['tab-bg-featured-size'] = 'full';
	$options['tab-bg-permalink-current-post'] = '_self';
	...
	// query editor / generator
	$options['sangar_query_post_type'] = '';
	$options['sangar_query_terms'] = '';
	$options['sangar_query_order_by'] = '';
	$options['sangar_query_order'] = '';
	$options['sangar_query_limit'] = '';
