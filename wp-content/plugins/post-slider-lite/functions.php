...
define('SSLIDER_CURRENT_ADDON','sangar_slider_post');
...
function sslider_admin_head()
{
    ...
    require_once( plugin_dir_path( __FILE__ ) . 'presets.php');
...
function sslider_admin_footer()
{
    ...
    require_once( plugin_dir_path( __FILE__ ) . 'modal-layer.php');
}
...
function sslider_admin_enqueue_scripts($hook)
{
    ...
    if($hook == 'post-new.php' || $hook == 'post.php')
    {
        ...
        wp_enqueue_style('sslider-admin-css',plugin_dir_url( __FILE__ )."assets/slider-admin.css",array(),SSLIDER_CURRENT_ADDON);        
        ...
        wp_enqueue_script('sslider-admin-query-js',plugin_dir_url( __FILE__ )."assets/slider-admin/adminQuery.js",array(),SANGAR_SLIDER_VERSION);
        wp_enqueue_script('sslider-admin-js',plugin_dir_url( __FILE__ )."assets/slider-admin.js",array(),SANGAR_SLIDER_VERSION);
        
        // jquery cloneya
        wp_enqueue_script('sslider-cloneya-js',plugin_dir_url( __FILE__ )."assets/jquery-cloneya.min.js",array(),SANGAR_SLIDER_VERSION);
    }
}