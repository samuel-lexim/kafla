...
if ( isset( $map_title ) && 'show' === $map_title ) {
	?>
	<div class="ux_div_title_container_<?php echo esc_attr( $random ); ?>" style="clear:both;">
...
if ( isset( $map_description ) && 'show' === $map_description ) {
	?>
	<div class="ux_div_description_container_<?php echo esc_attr( $random ); ?>" style="clear:both;">
...
?>
<div id="ux_div_map_canvas_front_end_<?php echo esc_attr( $random ); ?>" style="margin-top:5% !important;">
</div>
