...
class Vc_Base {
	...
	public function addIEMinimalSupport() {
		echo '<!--[if lte IE 9]><link rel="stylesheet" type="text/css" href="' . vc_asset_url( 'css/vc_lte_ie9.min.css' ) . '" media="screen">
			<meta http-equiv="X-UA-Compatible" content="IE=9">
			<script src="' . vc_asset_url( '/js/html5shiv.js' ) . '" type="text/javascript"></script>
 			<script src="' . vc_asset_url( '/js/respond.min.js' ) . '" type="text/javascript"></script><![endif]-->';
		echo '<!--[if IE  8]><link rel="stylesheet" type="text/css" href="' . vc_asset_url( 'css/vc-ie8.min.css' ) . '" media="screen">
