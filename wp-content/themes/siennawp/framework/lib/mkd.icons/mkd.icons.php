...
/*
  Class: SiennaMikadoIconCollections
...
class SiennaMikadoIconCollections {
	...
	private function initIconCollections() {
		$this->addIconCollection('font_awesome', new SiennaMikadoIconsFontAwesome("Font Awesome", "fa_icon"));
		$this->addIconCollection('font_elegant', new SiennaMikadoIconsFontElegant("Font Elegant", "fe_icon"));
		$this->addIconCollection('ion_icons', new SiennaMikadoIonIcons("Ion Icons", "ion_icon"));
		$this->addIconCollection('linea_icons', new SiennaMikadoLineaIcons('Linea Icons', 'linea_icon'));
		$this->addIconCollection('linear_icons', new SiennaMikadoLinearIcons('Linear Icons', 'linear_icon'));
		$this->addIconCollection('simple_line_icons', new SiennaMikadoSimpleLineIcons('Simple Line Icons',
			'simple_line_icons'));
		$this->addIconCollection('dripicons', new SiennaMikadoDripicons('Dripicons', 'dripicon'));
	}
	...
	public function getIconCollectionIcons(iSiennaMikadoIconCollection $collection) {
...
if ( ! function_exists( 'sienna_mikado_activate_theme_icons' ) ) {

    function sienna_mikado_activate_theme_icons() {
		global $sienna_mikado_IconCollections;
		$sienna_mikado_IconCollections = SiennaMikadoIconCollections::get_instance();
    }

    add_action('after_setup_theme', 'sienna_mikado_activate_theme_icons');
}