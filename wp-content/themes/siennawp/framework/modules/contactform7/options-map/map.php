...
if(!function_exists('sienna_mikado_contact_form_7_options_map')) {

	function sienna_mikado_contact_form_7_options_map() {
		...
		$panel_contact_form_style_1 = sienna_mikado_add_admin_panel(array(
		...
		$typography_text_group = sienna_mikado_add_admin_group(array(
		...
		$typography_text_row1 = sienna_mikado_add_admin_row(array(
		...
		$typography_text_row2 = sienna_mikado_add_admin_row(array(
		...
		$typography_text_row3 = sienna_mikado_add_admin_row(array(
		...
		$typography_label_group = sienna_mikado_add_admin_group(array(
		...
		$typography_label_row1 = sienna_mikado_add_admin_row(array(
		...
		$typography_label_row2 = sienna_mikado_add_admin_row(array(
		...
		$background_border_group = sienna_mikado_add_admin_group(array(
		...
		$background_border_row1 = sienna_mikado_add_admin_row(array(
		...
		$background_border_row2 = sienna_mikado_add_admin_row(array(
		...
		$background_border_row3 = sienna_mikado_add_admin_row(array(
		...
		$padding_group = sienna_mikado_add_admin_group(array(
			'name'        => 'padding_group',
		...
		$padding_row = sienna_mikado_add_admin_row(array(
			'name'   => 'padding_row',
		...
		$margin_group = sienna_mikado_add_admin_group(array(
			'name'        => 'margin_group',
		...
		$margin_row = sienna_mikado_add_admin_row(array(
			'name'   => 'margin_row',
			'parent' => $margin_group
		));
		...
		$button_typography_group = sienna_mikado_add_admin_group(array(
		...
		$button_typography_row1 = sienna_mikado_add_admin_row(array(
		...
		$button_typography_row2 = sienna_mikado_add_admin_row(array(
		...
		$button_background_border_group = sienna_mikado_add_admin_group(array(
		...
		$button_background_border_row1 = sienna_mikado_add_admin_row(array(
		...
		$button_background_border_row2 = sienna_mikado_add_admin_row(array(
		...
		$button_background_border_row3 = sienna_mikado_add_admin_row(array(
		...
		$panel_contact_form_style_2 = sienna_mikado_add_admin_panel(array(
			'page'  => '_contact_form7_page',
	...
	add_action('sienna_mikado_options_map', 'sienna_mikado_contact_form_7_options_map', 18);
