...
class SiennaMikadoLatestPosts extends SiennaMikadoWidget {
	protected $params;
	...
	public function __construct() {
		parent::__construct(
			...
			array('description' => esc_html__('Display posts from your blog', 'sienna'),) // Args
		);
	...
	protected function setParams() {
		$this->params = array(
			...
			array(
				...
				'type'    => 'dropdown',
				'title'   => 'Remove Comments on Image In Box',
				'options' => array(
					'yes' => 'Yes',
					'no'  => 'No'
				),
	...
	public function widget($args, $instance) {
		...
		echo sienna_mikado_execute_shortcode('mkdf_blog_list', $params);
