...
class SiennaMikadoInstagramWidget extends SiennaMikadoWidget {
	protected $params;
	...
	public function __construct() {
		parent::__construct(
			...
			array('description' => esc_html__('Display instagram images', 'sienna'))
		);
				...
				foreach($images_array as $image) { ?>
					<li>
						<a href="<?php echo esc_url($instagram_api->getHelper()->getImageLink($image)); ?>" target="_blank">
							<?php echo sienna_mikado_kses_img($instagram_api->getHelper()->getImageHTML($image, $image_size)); ?>
						</a>
					</li>
				<?php } ?>
			</ul>
