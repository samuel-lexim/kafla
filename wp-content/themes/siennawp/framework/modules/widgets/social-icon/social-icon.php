 ...
 */
class SiennaMikadoSocialIconWidget extends SiennaMikadoWidget {
	/**
	...
	protected function setParams() {
		$this->params = array_merge(
			sienna_mikado_icon_collections()->getSocialIconWidgetParamsArray(),
			array(
				array(
					'type'        => 'textfield',
					'title'       => 'Link',
	...
	public function widget($args, $instance) {
		...
		<a class="mkdf-social-icon-widget-holder" <?php echo sienna_mikado_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php sienna_mikado_inline_style($social_icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
