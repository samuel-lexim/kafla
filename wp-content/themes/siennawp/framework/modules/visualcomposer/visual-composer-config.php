...
if(!function_exists('sienna_mikado_configure_visual_composer')) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function sienna_mikado_configure_visual_composer() {
	...
	add_action('vc_after_init', 'sienna_mikado_configure_visual_composer');

}


if(!function_exists('sienna_mikado_configure_visual_composer_grid_elemets')) {
	...
	function sienna_mikado_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'sienna_mikado_configure_visual_composer_grid_elemets');
}


if(!function_exists('sienna_mikado_configure_visual_composer_frontend_editor')) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function sienna_mikado_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'sienna_mikado_configure_visual_composer_frontend_editor');
}
...
if(class_exists('WPBakeryShortCodesContainer')) {
	...
	class WPBakeryShortCode_Mkdf_Zooming_Slider extends WPBakeryShortCodesContainer {
	}

	class WPBakeryShortCode_Mkdf_Team_Slider extends WPBakeryShortCodesContainer {
	}

	class WPBakeryShortCode_Mkdf_Info_Card_Carousel extends WPBakeryShortCodesContainer {
	}
	...
	class WPBakeryShortCode_Mkdf_Item_Showcase_List_Item extends WPBakeryShortCodesContainer {

	}
}

/*** Row ***/
if(!function_exists('sienna_mikado_vc_row_map')) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function sienna_mikado_vc_row_map() {
	...
	add_action('vc_after_init', 'sienna_mikado_vc_row_map');
}

if(!function_exists('sienna_mikado_vc_empty_space_map')) {
	/**
	 * Adds responsive options to empty space shortcode
	 */
	function sienna_mikado_vc_empty_space_map() {
	...
	add_action('vc_after_init', 'sienna_mikado_vc_empty_space_map');
}