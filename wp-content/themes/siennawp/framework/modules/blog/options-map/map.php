...
if(!function_exists('sienna_mikado_blog_options_map')) {

	function sienna_mikado_blog_options_map() {
		...
		$panel_blog_lists = sienna_mikado_add_admin_panel(
			array(
				'page'  => '_blog_page',
		...
		if(count($custom_sidebars) > 0) {
			sienna_mikado_add_admin_field(array(
				...
				'parent'      => $panel_blog_lists,
				'options'     => sienna_mikado_get_custom_sidebars()
			));
		}
		...
		$pagination_container = sienna_mikado_add_admin_container(
			array(
		 ...
		 * Blog Single
		 */
		$panel_blog_single = sienna_mikado_add_admin_panel(
			array(
				'page'  => '_blog_page',
		...
		$blog_single_navigation_container = sienna_mikado_add_admin_container(
			array(
		...
		$blog_single_author_info_container = sienna_mikado_add_admin_container(
			array(
	...
	add_action('sienna_mikado_options_map', 'sienna_mikado_blog_options_map', 12);
