<?php if(sienna_mikado_options()->getOptionValue('blog_single_navigation') == 'yes') { ?>
    <?php $navigation_blog_through_category = sienna_mikado_options()->getOptionValue('blog_navigation_through_same_category') ?>
