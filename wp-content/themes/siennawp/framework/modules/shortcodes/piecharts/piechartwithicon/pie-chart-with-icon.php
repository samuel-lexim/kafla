<?php
namespace Sienna\Modules\PieCharts\PieChartWithIcon;
...
class PieChartWithIcon implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map( array(
			...
			'params' => array_merge(
				...
				sienna_mikado_icon_collections()->getVCParamsArray(),
				array(
					array(
						'type' => 'colorpicker',
						'heading' => 'Icon Color',
						'param_name' => 'icon_color',
						'dependency' => Array('element' => 'icon_pack', 'value' => sienna_mikado_icon_collections()->getIconCollectionsKeys()),
						'group' => 'Design Options',
					),
					array(
						'type' => 'textfield',
	...
	public function render($atts, $content = null)
	{
		...
		$params['active_color'] = $params['active_color'] !== '' ? $params['active_color'] : sienna_mikado_get_first_main_color();
		...
		$html = sienna_mikado_get_shortcode_module_template_part('templates/pie-chart-with-icon', 'piecharts/piechartwithicon', '', $params);
	...
	private function getPieChartIcon($params) {
		...
		$pie_chart_icon = sienna_mikado_icon_collections()->renderIcon( $params[$icon], $params['icon_pack'], $iconStyles );
