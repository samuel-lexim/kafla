<?php
namespace Sienna\Modules\Shortcodes\AnimationsHolder;
...
class AnimationsHolder implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				...
				'base'                    => $this->base,
				'as_parent'               => array('except' => 'vc_row, vc_accordion, vc_tabs, mkdf_elements_holder, mkdf_pricing_tables, mkdf_text_slider_holder, mkdf_info_card_carousel, mkdf_icon_slider'),
	...
	public function render($atts, $content = null) {
		...
		return sienna_mikado_get_shortcode_module_template_part('templates/animations-holder-template', 'animations-holder', '', $params);
	}
