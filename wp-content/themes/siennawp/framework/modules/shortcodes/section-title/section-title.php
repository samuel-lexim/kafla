<?php
namespace Sienna\Modules\Shortcodes\SectionTitle;

use Sienna\Modules\Shortcodes\Lib;
	...
	public function render($atts, $content = null) {
		...
		if($params['title'] !== '') {
			...
			if($params['margin_bottom'] !== '') {
				$params['section_title_styles'][] = 'margin-bottom: '.sienna_mikado_filter_px($params['margin_bottom']).'px';
			}

			$params['title_tag'] = $this->getTitleTag($params);

			return sienna_mikado_get_shortcode_module_template_part('templates/section-title-template', 'section-title', '', $params);
		}
	}
