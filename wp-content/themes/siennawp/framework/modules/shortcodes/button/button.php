<?php
namespace Sienna\Modules\Shortcodes\Button;
 ...
 * @package Sienna\Modules\Shortcodes\Button
 */
class Button implements ShortcodeInterface {
			...
			'params'                    => array_merge(
				...
				array(
					...
					array(
						...
						'heading'     => 'Margin',
						'param_name'  => 'margin',
						'description' => esc_html__('Insert margin in format: 0px 0px 1px 0px', 'sienna'),
						'admin_label' => true,
						'group'       => 'Design Options'
					)
				)
	...
	public function render($atts, $content = null) {
		...
		return sienna_mikado_get_shortcode_module_template_part('templates/'.$params['html_type'], 'button', '', $params);
	}
	...
	private function getButtonStyles($params) {
		...
		if(!empty($params['font_size'])) {
			$styles[] = 'font-size: '.sienna_mikado_filter_px($params['font_size']).'px';
		}
	...
	private function getButtonClasses($params) {
		...
		if(!empty($params['hover_border_color']) || !empty($params['border_color'])) {
			$buttonClasses[] = 'mkdf-btn-with-border';
		}
	...
	private function getHoverAnimation($params) {
		...
		return sienna_mikado_options()->getOptionValue('button_hover_animation');
	}
