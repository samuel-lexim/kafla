<?php
namespace Sienna\Modules\Shortcodes;
...
class IconProgressBar implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		return sienna_mikado_get_shortcode_module_template_part('templates/icon-progress-bar-template', 'icon-progress-bar', '', $params);
	}
	...
	private function getIconStyles($params) {
		...
		if($params['custom_icon_size'] !== '') {
			$styles[] = 'font-size: '.sienna_mikado_filter_px($params['custom_icon_size']).'px';
		}

		if($params['spacing_between_icons'] !== '') {
			$styles[] = 'margin-right: '.sienna_mikado_filter_px($params['spacing_between_icons']).'px';
		}
