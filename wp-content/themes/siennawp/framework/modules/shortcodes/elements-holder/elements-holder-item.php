<?php
namespace Sienna\Modules\ElementsHolderItem;
...
class ElementsHolderItem implements ShortcodeInterface {
				...
				array(
					...
					'params'                  => array(
						...
						array(
							...
							'heading'     => 'Padding on screen size between 1400px-1800px',
							'param_name'  => 'item_padding_1400_1800',
							'value'       => '',
							'description' => 'Please insert padding in format 0px 10px 0px 10px'
						),
						array(
							...
							'class'       => '',
							'group'       => 'Width & Responsiveness',
							'heading'     => 'Padding on screen size between 1280px-1400px',
							'param_name'  => 'item_padding_1280_1400',
							'value'       => '',
							'description' => 'Please insert padding in format 0px 10px 0px 10px'
						),
						array(
	...
	public function render($atts, $content = null) {
		$args = array(
			...
			'animation_name'         => '',
			'animation_delay'        => '',
			'item_padding_1400_1800' => '',
			'item_padding_1280_1400' => '',
		...
		$html = sienna_mikado_get_shortcode_module_template_part('templates/elements-holder-item-template', 'elements-holder', '', $params);
	...
	private function getElementsHolderItemContentResponsiveStyle($params) {
		...
		$element_holder_item_responsive_style['item_padding_1400_1800'] = $params['item_padding_1400_1800'] !== '' ? $params['item_padding_1400_1800'] : '';
		$element_holder_item_responsive_style['item_padding_1280_1400'] = $params['item_padding_1280_1400'] !== '' ? $params['item_padding_1280_1400'] : '';
		$element_holder_item_responsive_style['item_padding_1024_1280'] = $params['item_padding_1024_1280'] !== '' ? $params['item_padding_1024_1280'] : '';
		$element_holder_item_responsive_style['item_padding_768_1024']  = $params['item_padding_768_1024'] !== '' ? $params['item_padding_768_1024'] : '';
		$element_holder_item_responsive_style['item_padding_600_768']   = $params['item_padding_600_768'] !== '' ? $params['item_padding_600_768'] : '';
		$element_holder_item_responsive_style['item_padding_480_600']   = $params['item_padding_480_600'] !== '' ? $params['item_padding_480_600'] : '';
		$element_holder_item_responsive_style['item_padding_480']       = $params['item_padding_480'] !== '' ? $params['item_padding_480'] : '';
