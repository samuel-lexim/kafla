<div class="mkdf-elements-holder-item <?php echo esc_attr($elements_holder_item_class); ?>" <?php echo sienna_mikado_get_inline_attrs($elements_holder_item_data); ?> <?php echo sienna_mikado_get_inline_style($elements_holder_item_style); ?>>
	<div class="mkdf-elements-holder-item-inner">
		<div class="mkdf-elements-holder-item-content <?php echo esc_attr($elements_holder_item_content_class); ?>" <?php echo sienna_mikado_get_inline_style($elements_holder_item_content_style); ?>>
			<?php if(count($elements_holder_item_content_responsive) > 0) { ?>
				<style type="text/css" data-type="mkdf-elements-custom-padding" scoped>
					<?php if($elements_holder_item_content_responsive['item_padding_1400_1800'] !== '') { ?>
					@media only screen and (min-width: 1400px) and (max-width: 1800px) {
						.mkdf-elements-holder .mkdf-elements-holder-item-content.<?php echo esc_attr($elements_holder_item_content_class); ?> {
							padding: <?php echo esc_attr($elements_holder_item_content_responsive['item_padding_1400_1800']); ?> !important;
						}
					}

					<?php } ?>
					<?php if($elements_holder_item_content_responsive['item_padding_1280_1400'] !== '') { ?>
					@media only screen and (min-width: 1280px) and (max-width: 1400px) {
						.mkdf-elements-holder .mkdf-elements-holder-item-content.<?php echo esc_attr($elements_holder_item_content_class); ?> {
							padding: <?php echo esc_attr($elements_holder_item_content_responsive['item_padding_1280_1400']); ?> !important;
						}
					}
