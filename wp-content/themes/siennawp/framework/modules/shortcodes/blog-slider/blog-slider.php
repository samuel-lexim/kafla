<?php
namespace Sienna\Modules\Shortcodes\BlogSlider;
...
class BlogSlider implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		return sienna_mikado_get_shortcode_module_template_part('templates/blog-slider-template', 'blog-slider', '', $params);
	}
