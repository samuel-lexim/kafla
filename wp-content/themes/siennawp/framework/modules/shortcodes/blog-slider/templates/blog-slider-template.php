					...
					<div class="mkdf-bs-item-content">
						...
						<div class="mkdf-bs-item-bottom-section">
							<div class="mkdf-bs-item-author">
								<a href="<?php echo esc_url(sienna_mikado_get_author_posts_url()); ?>">
									<span class="mkdf-post-item-author-avatar-holder">
										<?php echo sienna_mikado_kses_img(get_avatar(get_the_author_meta('ID'), 30)); ?>
									</span>
									<span class="mkdf-post-item-author-name">
										<?php echo sienna_mikado_get_the_author_name(); ?>
									</span>
								</a>
							</div>
							<div class="mkdf-bs-item-categories">
								<?php echo sienna_mikado_icon_collections()->renderIcon('icon_tags', 'font_elegant'); ?>
								<?php the_category(', '); ?>
							</div>
						</div>
					</div>
