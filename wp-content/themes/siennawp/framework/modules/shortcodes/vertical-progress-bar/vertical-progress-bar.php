...
namespace Sienna\Modules\Shortcodes\VerticalProgressBar;
...
class VerticalProgressBar implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		return sienna_mikado_get_shortcode_module_template_part('templates/vertical-progress-bar', 'vertical-progress-bar', '', $params);
	}
