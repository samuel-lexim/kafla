...
namespace Sienna\Modules\BlogList;
...
class BlogList implements ShortcodeInterface {
		...
		vc_map(array(
			...
			'params'                    => array(
				array(
					...
					'holder'      => 'div',
					'class'       => '',
					'heading'     => esc_html__('Type', 'sienna'),
					'param_name'  => 'type',
					'value'       => array(
	...
	public function render($atts, $content = null) {
		...
		$html = '';
		$html .= sienna_mikado_get_shortcode_module_template_part('templates/blog-list-holder', 'blog-list', '', $params);
	...
	private function generateImageSize($params) {
		...
		switch($imageSize) {
			case 'landscape':
				$thumbImageSize = 'sienna_mikado_landscape';
				break;
			case 'square';
				$thumbImageSize = 'sienna_mikado_square';
				break;
			default:
				$thumbImageSize = 'full';
				break;
