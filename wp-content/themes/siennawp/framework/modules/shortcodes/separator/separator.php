<?php
namespace Sienna\Modules\Separator;
...
class Separator implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = sienna_mikado_get_shortcode_module_template_part('templates/separator-template', 'separator', '', $params);
	...
	private function getSeparatorStyle($params) {
		...
		if($params['width'] !== '') {
			if(sienna_mikado_string_ends_with($params['width'], '%') || sienna_mikado_string_ends_with($params['width'], 'px')) {
		...
		if($params['top_margin'] !== '') {
			if(sienna_mikado_string_ends_with($params['top_margin'], '%') || sienna_mikado_string_ends_with($params['top_margin'], 'px')) {
		...
		if($params['bottom_margin'] !== '') {
			if(sienna_mikado_string_ends_with($params['bottom_margin'], '%') || sienna_mikado_string_ends_with($params['bottom_margin'], 'px')) {
