<?php
namespace Sienna\Modules\Shortcodes\ImageGallery;
...
class ImageGallery implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            ...
            'params'                    => array(
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => 'Choose navigation skin',
                    'param_name'  => 'ls_navigation',
                    'value'       => array(
                        'Light' => 'light',
                        'Dark'  => 'dark'
                    ),
    ...
    public function render($atts, $content = null) {
        ...
        $params['image_carousel_data'] = $this->getImageCarouselDataAttributes($params);
        ...
        $light_nav = '';
        if($params['ls_navigation'] === 'light') {
            $light_nav = ' mkdf-light-nav';
        }

        $params['light_navigation'] = $light_nav;

        $image_hover = '';
        if($params['circle_overlay_hover'] === 'yes') {
            $image_hover = ' mkdf-image-galley-circle-overlay';
        }
        ...
        if($params['spacing'] == 'small') {
            ...
            $image_space .= ' mkdf-no-space';
        }


        $params['space'] = $image_space;

        $html = sienna_mikado_get_shortcode_module_template_part('templates/'.$template, 'imagegallery', '', $params);
    ...
    private function getImageCarouselDataAttributes($params) {
