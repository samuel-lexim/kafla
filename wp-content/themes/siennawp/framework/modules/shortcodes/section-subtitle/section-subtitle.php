<?php
namespace Sienna\Modules\Shortcodes\SectionSubtitle;
...
class SectionSubtitle implements Lib\ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		if($params['text'] !== '') {
			...
			return sienna_mikado_get_shortcode_module_template_part('templates/section-subtitle-template', 'section-subtitle', '', $params);
		}
	}
