...
if(!function_exists('sienna_mikado_sidearea_options_map')) {

	function sienna_mikado_sidearea_options_map() {
		...
		$side_area_panel = sienna_mikado_add_admin_panel(
			array(
				'title' => 'Side Area',
				'name'  => 'side_area',
		...
		$side_area_width_container = sienna_mikado_add_admin_container(
			array(
				'parent'          => $side_area_panel,
		...
		$side_area_slide_with_content_container = sienna_mikado_add_admin_container(
			array(
				'parent'          => $side_area_panel,
...
//do we have some collection added in collections array?
		if(is_array(sienna_mikado_icon_collections()->iconCollections) && count(sienna_mikado_icon_collections()->iconCollections)) {
			...
			$side_area_icon_collections_params = sienna_mikado_icon_collections()->getIconCollectionsParams();
		...
		$side_area_opener_icon_container_no_style = sienna_mikado_add_admin_container_no_style(array(
		...
		sienna_mikado_add_admin_field(
			array(
				...
				'options'       => sienna_mikado_icon_collections()->getIconCollections(),
				'args'          => array(
					'dependence' => true,
		...
		if(is_array(sienna_mikado_icon_collections()->iconCollections) && count(sienna_mikado_icon_collections()->iconCollections)) {
			...
			foreach(sienna_mikado_icon_collections()->iconCollections as $collection_key => $collection_object) {
				...
				$side_area_icon_container = sienna_mikado_add_admin_container(
					array(
						'parent'          => $side_area_opener_icon_container_no_style,
		...
		$side_area_icon_style_group = sienna_mikado_add_admin_group(
			array(
				'parent'      => $side_area_panel,
		...
		$side_area_icon_style_row1 = sienna_mikado_add_admin_row(
			array(
		...
		$side_area_icon_style_row2 = sienna_mikado_add_admin_row(
			array(
				'parent' => $side_area_icon_style_group,
		...
		$side_area_icon_style_row3 = sienna_mikado_add_admin_row(
			array(
				'parent' => $side_area_icon_style_group,
		...
		$icon_spacing_group = sienna_mikado_add_admin_group(
			array(
				'parent'      => $side_area_panel,
		...
		$icon_spacing_row = sienna_mikado_add_admin_row(
			array(
		...
		$side_area_icon_border_container = sienna_mikado_add_admin_container(
			array(
				'parent'          => $side_area_panel,
		...
		$border_style_group = sienna_mikado_add_admin_group(
			array(
		...
		$border_style_row_1 = sienna_mikado_add_admin_row(
			array(
		...
		$border_style_row_2 = sienna_mikado_add_admin_row(
			array(
				'parent' => $border_style_group,
		...
		$padding_group = sienna_mikado_add_admin_group(
			array(
				'parent'      => $side_area_panel,
				'name'        => 'padding_group',
				'title'       => 'Padding',
		...
		$padding_row = sienna_mikado_add_admin_row(
			array(
		...
		$title_group = sienna_mikado_add_admin_group(
			array(
				'parent'      => $side_area_panel,
				'name'        => 'title_group',
				'title'       => 'Title',
		...
		$title_row_1 = sienna_mikado_add_admin_row(
			array(
				'parent' => $title_group,
				'name'   => 'title_row_1',
			)
		...
		$title_row_2 = sienna_mikado_add_admin_row(
			array(
				'parent' => $title_group,
				'name'   => 'title_row_2',
				'next'   => true
		...
		$text_group = sienna_mikado_add_admin_group(
			array(
				'parent'      => $side_area_panel,
				'name'        => 'text_group',
				'title'       => 'Text',
		...
		$text_row_1 = sienna_mikado_add_admin_row(
			array(
				'parent' => $text_group,
				'name'   => 'text_row_1',
			)
		...
		$text_row_2 = sienna_mikado_add_admin_row(
			array(
				'parent' => $text_group,
				'name'   => 'text_row_2',
				'next'   => true
		...
		$widget_links_group = sienna_mikado_add_admin_group(
			array(
				'parent'      => $side_area_panel,
		...
		$widget_links_row_1 = sienna_mikado_add_admin_row(
			array(
		...
		$widget_links_row_2 = sienna_mikado_add_admin_row(
			array(
				'parent' => $widget_links_group,
		...
		$widget_links_row_3 = sienna_mikado_add_admin_row(
			array(
				'parent' => $widget_links_group,
		...
		$side_area_bottom_border_container = sienna_mikado_add_admin_container(
			array(
				'parent'          => $side_area_panel,
	...
	add_action('sienna_mikado_options_map', 'sienna_mikado_sidearea_options_map', 5);
