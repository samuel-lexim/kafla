...
if(!function_exists('sienna_mikado_woocommerce_options_map')) {

	/**
	 * Add Woocommerce options page
	 */
	function sienna_mikado_woocommerce_options_map() {
		 ...
		 */
		$panel_product_list = sienna_mikado_add_admin_panel(
			array(
		 ...
		 */
		$panel_single_product = sienna_mikado_add_admin_panel(
			array(
				'page'  => '_woocommerce_page',
		...
		sienna_mikado_add_admin_field(array(
			...
			'default_value' => '',
			'description'   => 'Enter text that you want to appear bellow related posts section title',
			'parent'        => $panel_single_product
		));
	}

	add_action('sienna_mikado_options_map', 'sienna_mikado_woocommerce_options_map', 19);
