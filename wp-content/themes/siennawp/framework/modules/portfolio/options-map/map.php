...
if(!function_exists('sienna_mikado_portfolio_options_map')) {

    function sienna_mikado_portfolio_options_map() {
        ...
        $container_navigate_category = sienna_mikado_add_admin_container(array(
        ...
        sienna_mikado_add_admin_field(array(
            'name'          => 'portfolio_single_overlay',
            'type'          => 'yesno',
            'label'         => 'Enable Circle Hover Overlay On Gallery',
            'description'   => 'Enabling this option will show overlay hover on your Gallery.',
            'parent'        => $panel,
            'default_value' => 'no'
        ));
    ...
    add_action('sienna_mikado_options_map', 'sienna_mikado_portfolio_options_map', 14);
