<?php
namespace Sienna\Modules\Header\Lib;
...
class HeaderConnector {
	...
	public function connect($config = array()) {
		...
		if(!empty($config['affect_title'])) {
			add_filter('sienna_mikado_title_content_padding', array($this, 'titlePaddingFilter'));
		}

		if(!empty($config['affect_slider'])) {

			add_filter('sienna_mikado_slider_item_padding', array($this, 'sliderItemPaddingFilter'));
			add_filter('sienna_mikado_slider_navigation_padding', array(
				$this,
				'sliderNavigationPaddingFilter'
			));
		}

		do_action('sienna_mikado_after_header_connect');
	}
	 ...
	 *
	 * Hooks to sienna_mikado_title_content_padding filter
	 *
	 * @return int
	 */
	 ...
	 *
	 * Hooks to sienna_mikado_slider_item_padding filter
	 *
	 * @return int
	 */
