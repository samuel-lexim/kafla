...
if(!function_exists('sienna_mikado_header_meta_box_map')) {
	/**
	 * Header meta box map
	 */
	function sienna_mikado_header_meta_box_map() {
	    $header_meta_box = sienna_mikado_add_meta_box(
		    array(
	    ...
	    switch(sienna_mikado_options()->getOptionValue('header_type')) {
		    case 'header-standard':
			    ...
			    $border_bottom_color_container = sienna_mikado_add_admin_container(array(
				    'type'            => 'container',
	    ...
	    if(sienna_mikado_options()->getOptionValue('header_type') != 'header-vertical') {
		    $sticky_amount_container = sienna_mikado_add_admin_container_no_style(array(
		    ...
		    $sticky_amount_group = sienna_mikado_add_admin_group(array(
		    ...
		    $sticky_amount_row = sienna_mikado_add_admin_row(array(
			    'name'   => 'sticky_amount_group',
		    ...
		    $top_bar_global_option      = sienna_mikado_options()->getOptionValue('top_bar');
		    ...
		    $top_bar_container = sienna_mikado_add_admin_container_no_style(array(
	...
	add_action('sienna_mikado_meta_boxes_map', 'sienna_mikado_header_meta_box_map');
}