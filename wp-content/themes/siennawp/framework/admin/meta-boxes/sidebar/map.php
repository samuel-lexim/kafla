...
if(!function_exists('sienna_mikado_sidebar_meta_box_map')) {
	/**
	 * Sidebar meta box map
	 */
	function sienna_mikado_sidebar_meta_box_map() {
		$custom_sidebars = sienna_mikado_get_custom_sidebars();

		$sidebar_meta_box = sienna_mikado_add_meta_box(
			array(
	...
	add_action('sienna_mikado_meta_boxes_map', 'sienna_mikado_sidebar_meta_box_map');
}
