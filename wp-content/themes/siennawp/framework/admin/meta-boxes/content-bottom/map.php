...
if(!function_exists('sienna_mikado_content_bottom_meta_box_map')) {
	/**
	 * Content bottom meta box map
	 */
	function sienna_mikado_content_bottom_meta_box_map() {
		$content_bottom_meta_box = sienna_mikado_add_meta_box(
			array(
		...
		$show_content_bottom_meta_container = sienna_mikado_add_admin_container(
			array(
				'parent'          => $content_bottom_meta_box,
	...
	add_action('sienna_mikado_meta_boxes_map', 'sienna_mikado_content_bottom_meta_box_map');
}