...
if(!function_exists('sienna_mikado_video_post_format_meta_box_map')) {
	/**
	 * Video post format meta box map
	 */
	function sienna_mikado_video_post_format_meta_box_map() {
		$video_post_format_meta_box = sienna_mikado_add_meta_box(
			array(
				'scope' => array('post'),
		...
		$mkdf_video_embedded_container = sienna_mikado_add_admin_container(
			array(
				'parent'          => $video_post_format_meta_box,
		...
		$mkdf_video_self_hosted_container = sienna_mikado_add_admin_container(
			array(
				'parent'          => $video_post_format_meta_box,
	...
	add_action('sienna_mikado_meta_boxes_map', 'sienna_mikado_video_post_format_meta_box_map');
}