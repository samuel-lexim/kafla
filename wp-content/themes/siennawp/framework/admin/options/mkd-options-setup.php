...
add_action('after_setup_theme', 'sienna_mikado_admin_map_init', 0);

function sienna_mikado_admin_map_init() {

	do_action('sienna_mikado_before_options_map');
	...
	do_action('sienna_mikado_options_map');

	do_action('sienna_mikado_after_options_map');
