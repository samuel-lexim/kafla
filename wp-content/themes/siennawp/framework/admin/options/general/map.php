...
if(!function_exists('sienna_mikado_general_options_map')) {
    /**
     * General options page
     */
    function sienna_mikado_general_options_map() {
        ...
        $panel_logo = sienna_mikado_add_admin_panel(
            array(
                'page'  => '',
                'name'  => 'panel_logo',
                'title' => 'Branding'
        ...
        $hide_logo_container = sienna_mikado_add_admin_container(
            array(
                'parent'          => $panel_logo,
        ...
        $panel_design_style = sienna_mikado_add_admin_panel(
            array(
                'page'  => '',
        ...
        $additional_google_fonts_container = sienna_mikado_add_admin_container(
            array(
                'parent'          => $panel_design_style,
        ...
        $boxed_container = sienna_mikado_add_admin_container(
            array(
                'parent'          => $panel_design_style,
        ...
        $panel_settings = sienna_mikado_add_admin_panel(
            array(
                'page'  => '',
                'name'  => 'panel_settings',
                'title' => 'Behavior'
        ...
        $page_transitions_container = sienna_mikado_add_admin_container(
            array(
                'parent'          => $panel_settings,
        ...
        $group_pt_spinner_animation = sienna_mikado_add_admin_group(array(
        ...
        $row_pt_spinner_animation = sienna_mikado_add_admin_row(array(
        ...
        $panel_custom_code = sienna_mikado_add_admin_panel(
            array(
                'page'  => '',
    ...
    add_action('sienna_mikado_options_map', 'sienna_mikado_general_options_map', 1);
