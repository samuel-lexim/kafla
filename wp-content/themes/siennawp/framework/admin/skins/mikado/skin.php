...
class MikadoSkin extends SiennaMikadoSkinAbstract {
    /**
     * Skin constructor. Hooks to sienna_mikado_admin_scripts_init and sienna_mikado_enqueue_admin_styles
     */
     ...
     *
*@param SiennaMikadoAdminPage $page current page to load
