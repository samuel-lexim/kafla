...
sienna_mikado_get_title();
get_template_part('slider');

$full_width = false;

if(sienna_mikado_options()->getOptionValue('mkdf_woo_products_list_full_width') == 'yes' && !is_singular('product')) {
	$full_width = true;
}

if($full_width) { ?>
<div class="mkdf-full-width" <?php sienna_mikado_inline_style($background_color); ?>>
	<?php } else { ?>
	<div class="mkdf-container" <?php sienna_mikado_inline_style($background_color); ?>>
		<?php }
		if($full_width) { ?>
		<div class="mkdf-full-width-inner" <?php sienna_mikado_inline_style($content_style); ?>>
			<?php } else { ?>
			<div class="mkdf-container-inner clearfix" <?php sienna_mikado_inline_style($content_style); ?>>
				<?php }
				...
				if(!is_singular('product')) {
					...
					switch($sidebar) {
							...
							<div class="mkdf-two-columns-66-33 grid2 mkdf-woocommerce-with-sidebar clearfix">
								<div class="mkdf-column1">
									<div class="mkdf-column-inner">
										<?php sienna_mikado_woocommerce_content(); ?>
									</div>
								</div>
						...
						case 'sidebar-25-left': ?>
							...
							break;
						default:
							sienna_mikado_woocommerce_content();
					}
